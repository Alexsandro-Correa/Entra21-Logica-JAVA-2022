...
public class ExercicioMatrizes {
	...
	public static void inicializarMatriz2Niveis() {
		...
		byte matrizBytes[][] = { // Quem define o tamanho de cada vetor é a inicialização que pode ser irregular
				{ 10, 20, 30, 42, 50 }, { 15, 20, 33 }, { 12, 26 }, { 10 } };

		short matrizShorts[][] = { { 300, 450, 1000 }, { 560, 600, 700 }, { 250, 3800, 4500 } };

		int matrizInts[][] = { { 23000, 36000 }, { 46000, 52000 }, { 37000, 49000 }

		};

		long matrizLongs[][] = { { 300000, 680000, 520000 }, { 112000, 368222, 123564 }, { 789655, 690000, 258000 }

		};

		float matrizFloats[][] = { { 15000.65f, 150000 }, { 16800.82f, 320000.9f }, { 368000, 850230.64f }

		};

		double matrizDoubles[][] = { { 150000.45d, 236.50d }, { 850000.98d, 123456.789d }, { 658900.333d, 333333.3333d }
