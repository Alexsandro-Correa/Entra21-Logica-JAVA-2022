package br.com.entra21.aulaslogicaprogramacaojava.condicao_switch_case;
...
public class CondicionalSwitchCase extends Menu {

	public CondicionalSwitchCase(String title, ArrayList<String> matters) {
		super(title, matters);
	...
	private static void aprenderSwitchCase() {
