...
É importante acessar os exercícios com um menu
...
- 8: Escreva um algoritmo que leia uma sequência de números do usuário e realize a soma desses números e encerre a execução quando um número negativo for digitado.
